...
abstract interface class VideoTitle {
  ...
  /// Human-readable label for each audio stream (same length as audioStreamCount).
  List<String> get audioTrackLabels;

  /// Human-readable label for each subtitle stream (same length as subtitleStreamCount).
  List<String> get subtitleTrackLabels;

  /// Lowercase ISO 639 language code for each audio stream (same length as audioStreamCount).
  List<String> get audioLangCodes;

  /// Lowercase ISO 639 language code for each subtitle stream (same length as subtitleStreamCount).
  List<String> get subtitleLangCodes;
